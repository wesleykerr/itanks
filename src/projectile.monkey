...
Class Projectile
	...
	Method New()
		image = game.images.Find("Projectile")
		explosionSound = game.sounds.Find("explosion")
		bounceSound = game.sounds.Find("bounce")
		tankExplosionSound = game.sounds.Find("tankExplosion")
	End
